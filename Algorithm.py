...
GAMMA = .9
MAX_OUNOISE_SIGMA = .8
custom_ounoise_sigma = 0.   # 如果是 -1，则从 MAX_OUNOISE_SIGMA 开始逐渐减小探索度，否则按照指定的值来设置探索度
...
class DDPG_Algorithm:
    ...
    def execute(self):
        ...
        action_raw = self.agent.select_action(torch.Tensor([s]), action_noise=self.ounoise)  # (-1., 1.)
